...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    protected function permissionDefinitions(): array
    {
        ...
        $entities = [
            ...
            'personnel_administratif_mouvement',
            'evaluation',
        ...
        $specialPermissions = [
            ...
            ['name' => 'view_hr_dashboard', 'description' => 'Consulter le tableau de bord RH.', 'group_name' => 'hr'],
            ['name' => 'view_hr_employees', 'description' => 'Voir les employés RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr', 'description' => 'Gérer le module RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_employees', 'description' => 'Gérer les employés RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_departments', 'description' => 'Gérer les départements RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_positions', 'description' => 'Gérer les postes RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_services', 'description' => 'Gérer les services RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_functions', 'description' => 'Gérer les fonctions RH.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_staff', 'description' => 'Gérer le personnel administratif.', 'group_name' => 'hr'],
            ['name' => 'manage_hr_learning', 'description' => 'Gérer les formations RH.', 'group_name' => 'hr'],
            ['name' => 'export_hr_reports', 'description' => 'Exporter les rapports RH.', 'group_name' => 'hr'],
    ...
    protected function seedSuperAdminUser(array $allPermissionNames): void
    {
        ...
        $email = env('SUPADMIN_EMAIL', 'superadmin@gmail.com');
        $password = env('SUPADMIN_PASSWORD', 'Advanced2026');
