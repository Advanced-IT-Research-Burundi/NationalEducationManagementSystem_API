...
$request = Illuminate\Http\Request::create('/api/academic/statistics/dashboard/national', 'GET');
...
try {
    $controller = app(\App\Http\Controllers\Api\Statistics\DashboardController::class);
    $response = $controller->national($request);
