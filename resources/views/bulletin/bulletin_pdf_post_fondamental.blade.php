...
<div class="page">
  ...
  <table>
    ...
    <tr class="total-row">
      ...
      <td colspan="3"></td>
      <td>{{ $t1Complete && $grandT1Points !== null && $grandT1Max > 0 ? round(($grandT1Points / $grandT1Max) * 100, 1): '' }}</td>

      <td colspan="3"></td>
      <td>{{ $t2Complete && $grandT2Points !== null && $grandT2Max > 0 ? round(($grandT2Points / $grandT2Max) * 100, 1): '' }}</td>

      <td colspan="3"></td>
      <td>{{ $t3Complete && $grandT3Points !== null && $grandT3Max > 0 ? round(($grandT3Points / $grandT3Max) * 100, 1): '' }}</td>
    ...
    <tr class="total-row" style="border-bottom: 2px solid #000;">
      ...
      <td colspan="3"></td>
      <td>@php($rT1 = ($bulletin['trimestres']['1er Trimestre'] ?? [])['rang'] ?? null){{ \App\Support\BulletinCourseLayout::formatPlace($rT1, $t1Complete) }}</td>

      <td colspan="3"></td>
      <td>@php($rT2 = ($bulletin['trimestres']['2e Trimestre'] ?? [])['rang'] ?? null){{ \App\Support\BulletinCourseLayout::formatPlace($rT2, $t2Complete) }}</td>

      <td colspan="3"></td>
      <td>@php($rT3 = ($bulletin['trimestres']['3e Trimestre'] ?? [])['rang'] ?? null){{ \App\Support\BulletinCourseLayout::formatPlace($rT3, $t3Complete) }}</td>
