...
class UpdateCampagneInscriptionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'type' => ['sometimes', 'required', Rule::in(CampagneType::values())],
            'date_ouverture' => ['sometimes', 'required', 'date'],
            'date_cloture' => ['sometimes', 'required', 'date', 'after:date_ouverture'],
